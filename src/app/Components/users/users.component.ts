...
export class UsersComponent implements OnInit {
  ...
  constructor(private user:UserStoreService,private _snackBar: MatSnackBar ,private dossierService : DossierService, private api : GenericService , private fb :FormBuilder){}
  addUser(){
